    ...
    headers: {
      ...
      contentSecurityPolicy: {
        ...
        'script-src': [
          ...
          'https://*.facebook.net',
          'https://wa.me',
          // Beacon injetado pelo proxy Cloudflare (Web Analytics).
        ...
        // Aberto: proxy Cloudflare + GA/Pixel. Não omitir a diretiva.
        // WebKit: `*` sozinho não equivale a `https:`.
        'connect-src': [
          "'self'",
          '*',
          'https:',
        ...
        // GTM/Pixel + overlay Nuxt (`about:srcdoc`). `about:` cobre blank/srcdoc.
        'frame-src': [
          "'self'",
          'about:',
          'blob:',
